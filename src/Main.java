    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(carRental.getInvoice() != null) {
                ...
                System.out.println("Invoice not generated due to data error.");
            }
        }
        catch (DateTimeParseException e){
            System.out.println("Error: date format not allowed. Use dd/MM/yyyy HH:mm.");
        }
